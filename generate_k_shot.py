...
def main():
    ...
    parser.add_argument("--dataset", type=str, default="CPR", help="Path to original data")
    parser.add_argument("--data_file", type=str, default='aaaaaa.txt', choices=['aaaaaa.txt', 'val.txt'], help="k-shot or k-shot-10x (10x dev set)")
    ...
    for seed in args.seed:
        ...
        with open(os.path.join(setting_dir, "aaaaaa.txt"), "w") as f:
            file_list = []
